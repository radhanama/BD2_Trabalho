create tablespace tpch DATAFILE 'tpch.dbf' SIZE 64M AUTOEXTEND ON;

CREATE USER tpch IDENTIFIED BY "<senha>" DEFAULT TABLESPACE tpch TEMPORARY TABLESPACE temp QUOTA UNLIMITED ON tpch;

grant create session to tpch;
grant alter session to tpch;
grant create cluster to tpch;
grant create database link to tpch;
grant create sequence to tpch;
grant create synonym to tpch;
grant create table to tpch;
grant create view to tpch;
grant create trigger to tpch;
grant create procedure to tpch;
--grant create user to tpch; 
